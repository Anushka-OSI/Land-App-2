...
<section class="hero" id="hero" aria-label="Homepage hero banner">
    ...
    <div class="container">
        <div class="hero-content">
            ...
            {{-- Description --}}
            <p class="hero-desc">
                Securing land ownership rights for every Sri Lankan citizen through transparent title registration and
                land settlement services across all 25 districts.
            </p>
            ...
            <div class="hero-actions">
                ...
                <a href="javascript:void(0);"
                    onclick="const sl = document.getElementById('latest-news-slideshow'); sl.classList.add('visible'); setTimeout(() => sl.scrollIntoView({behavior:'smooth'}), 150);"
                    class="btn btn-outline" id="hero-cta-news">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                        style="width:18px;height:18px;">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
